...
| | |
|---|---|
| **Nombre** | Daniel Soto V. |
| **Rol** | Instructor / Profesor |
| **Correo institucional** | *[correo@institucion.edu]* |
| **GitHub** | [@DanielSotoV](https://github.com/DanielSotoV) |
...
| Día | Hora | Modalidad |
|-----|------|-----------|
| Lunes | 10:00 – 12:00 | Presencial – Oficina 205 |
...
- **Plataforma del curso**: Para entrega de tareas, calificaciones y anuncios.
...
1. **El nombre de la materia** y el tema específico.
2. **El error o duda específica** (incluye el mensaje de error si aplica).
3. **Lo que ya intentaste** antes de consultar.
4. **El fragmento de código relevante** (usa bloques de código en Markdown).
